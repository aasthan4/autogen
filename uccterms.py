...
def express():
    ...
    '''
    driv2.driver(['X2','F1'])
    driv2.driver(['X2','F1','T1'])
    driv2.driver(['X2','F1','T2'])
    driv2.driver(['X2','F1','T1','T11'])
    driv2.driver(['X2','F1','T2','T21'])
    driv2.driver(['X2','F1','T1','T2'])
    driv2.driver(['X2','F1','T1','T11','T12'])
    driv2.driver(['X2','F1','T1','T11','T2'])
    driv2.driver(['X2','F1','T1','T2','T21'])
    driv2.driver(['X2','F1','T2','T21','T22'])
    '''
