...
list_terms.extend(prod(['X1'],comm(comm(comm(['V2'],['T11'],0),['D12'],0),['T23'],0),-1.0/6.0))
list_terms=full_con.full_terms(list_terms)
'''
list_terms.extend(prod(['X1'],comm(comm(comm(['V2'],['T11'],0),['D12'],0),['T23'],0),-1.0/6.0))
list_terms=full_con.full_terms(list_terms)
list_terms.extend(prod(['X1'],comm(comm(comm(['V2'],['D11'],0),['T22'],0),['T13'],0),-1.0/6.0))
list_terms=full_con.full_terms(list_terms)
list_terms.extend(prod(['X1'],comm(comm(comm(['V2'],['T11'],0),['D22'],0),['T13'],0),-1.0/6.0))
list_terms=full_con.full_terms(list_terms)
list_terms.extend(prod(['X1'],comm(comm(comm(['V2'],['T21'],0),['D12'],0),['T13'],0),-1.0/6.0))
list_terms=full_con.full_terms(list_terms)
list_terms.extend(prod(['X1'],comm(comm(comm(['V2'],['T21'],0),['T12'],0),['D13'],0),-1.0/6.0))
list_terms=full_con.full_terms(list_terms)
'''
list_terms=ce.compare_envelope(list_terms,1.0,1)
